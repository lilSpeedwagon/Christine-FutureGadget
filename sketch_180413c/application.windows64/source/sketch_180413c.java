...
public class sketch_180413c extends PApplet {
...
public void keyPressed()  {
  ...
  if (fileLoaded)  {
    if (key == CODED)  {
      ...
      switch(key)  {
        case '+':
          imageWidget.scale(1.1f);
          break;
        case '-':
          imageWidget.scale(0.9f);
          break;
      }
    }
    imageWidget.drawWidget();
...
class Button  {
  ...
  public Button(float x, float y, float w, float h, String bText, int clr) {
    this.x = x;
    this.y = y;
    this.w = w;
    this.h = h;
...
class ImageWidget  {
  ...
  public void settings() {  size(800, 560); }
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--present", "--window-color=#666666", "--stop-color=#cccccc", "sketch_180413c" };
    if (passedArgs != null) {
